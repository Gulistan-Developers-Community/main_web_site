        ...
        <div className='absolute inset-0 bg-white text-slate-900 text-lg mx-auto'>
            ...
            <div className='p-4 flex flex-col gap-3'>
                <h2 onClick={() => {
                    logout()
                    setOpenModal(false)
                }} className='flex select-none duration-300 justify-center hover:pl-2 cursor-pointer'>Logout</h2>
               
                
            </div>
             <h2 className='flex select-none duration-300 justify-center hover:pl-2 cursor-pointer'>
                    <Link href='/cabinet/editing' onClick={()=>{setOpenModal(false)}}>Edit Profile</Link>
                </h2>
